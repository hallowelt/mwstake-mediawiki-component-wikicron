...
-- Source: vendor/mwstake/mediawiki-component-wikicron/db/wiki-cron.json
-- Do not modify this file directly.
-- See https://www.mediawiki.org/wiki/Manual:Schema_changes
CREATE TABLE /*_*/wiki_cron (
  wc_name VARBINARY(255) NOT NULL,
  wc_wiki_id VARBINARY(255) NOT NULL,
  wc_id INT UNSIGNED DEFAULT 1 NOT NULL,
...
CREATE TABLE /*_*/wiki_cron_history (
  ...
  wch_wiki_id VARBINARY(255) DEFAULT NULL
) /*$wgDBTableOptions*/;
